      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-2 md:gap-0 xl:mt-24">
          ...
          <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p class="mt-5 text-lg text-gray-600 font-pj uppercase">
              Collaborations
            </p>
          </div>
          <div class="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            <h3 class="mt-12 text-5xl font-bold text-gray-900 font-pj">14</h3>
            <p class="mt-5 text-lg text-gray-600 font-pj uppercase">
              Years of CSI
            </p>
          </div>
          <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            <h3 class="mt-12 text-5xl font-bold text-gray-900 font-pj">
              1000+
            </h3>
            <p class="mt-5 text-lg text-gray-600 font-pj uppercase">
              Participations
