    ...
    if (isVisible) {
      const interval = setInterval(() => {
        setCounts(prevCounts => ({
          members: prevCounts.members < 50 ? prevCounts.members + 1 : prevCounts.members,
          collaborations: prevCounts.collaborations < 50 ? prevCounts.collaborations + 1 : prevCounts.collaborations,
          yearsOfCSI: prevCounts.yearsOfCSI < 14 ? prevCounts.yearsOfCSI + 1 : prevCounts.yearsOfCSI,
          participations: prevCounts.participations < 1000 ? prevCounts.participations + 10 : prevCounts.participations
        }));
          ...
          <>
            <div className="text-center">
              <motion.section className="text-center py-5" initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} >
                <motion.div key="members" initial={{ opacity: 0, scale: 0.8 }}  animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }} className="md:p-8 lg:p-14" >
          ...
          <AnimatePresence>
            {isVisible && (
              <>
                ...
                >
                  <h3 className="mt-12 text-5xl font-bold text-gray-900 font-pj">{counts.members}+</h3>
                ...
                >
                  <h3 className="mt-12 text-5xl font-bold text-gray-900 font-pj">{counts.collaborations}+</h3>
                ...
                >
                  <h3 className="mt-12 text-5xl font-bold text-gray-900 font-pj">{counts.yearsOfCSI}</h3>
                  <p className="mt-5 text-lg text-gray-600 font-pj uppercase">
                    Years of CSI
                  </p>
                </motion.div>
