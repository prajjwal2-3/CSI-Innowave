...
const Gallery = () => {
  return (
    <div>
         <div className="sm:h-[60rem] h-screen overflow-hidden w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex py-16 sm:py-20   justify-center">
